<footer class="bg-dark text-center fixed-bottom">
    ...
    <div class="pt-3">
        ...
        <div class="btn-group btn-group-toggle">
            ...
            <button onclick="changeFontSize('decrease');" class="btn btn-secondary">-</button>
            <button onclick="changeFontSize('increase');" class="btn btn-secondary">+</button>
        </div>
    </div>

    <div class="text-center p-3 text-light">
        Marceli Hryniuk | Nr. indeksu: 20186

        <!-- Copyright -->
        <span class="text-muted">
            © 2024 Copyright:
            <a class="" target="_blank" href="https://getbootstrap.com/">Bootstrap.com</a>
        </span>
        <!-- Copyright -->
    </div>
